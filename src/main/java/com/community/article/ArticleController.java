...
public class ArticleController {
    ...
    public Result<IPage<ArticleVO>> list(@RequestParam(defaultValue = "1") Integer page,
        ...
        return Result.success(articleQueryService.list(page, size));
    }
    ...
    public Result<IPage<ArticleVO>> search(@RequestParam String keyword,
                                           ...
                                           @RequestParam(defaultValue = "10") Integer size) {
        return Result.success(articleQueryService.search(keyword, page, size));
    }
    ...
    public Result<LikeVO> like(@PathVariable Long id) {
        return Result.success(articleInteractionService.toggleLike(id));
    }
    ...
    public Result<IPage<ArticleVO>> my(@RequestParam(required = false) Integer status,
                                       @RequestParam(defaultValue = "1") Integer page,
                                       @RequestParam(defaultValue = "10") Integer size) {
        return Result.success(articleQueryService.listMyArticles(status, page, size));
    }
    ...
    public Result<FavoriteVO> favorite(@PathVariable Long id) {
        return Result.success(articleInteractionService.toggleFavorite(id));
    }
    ...
    public Result<IPage<ArticleVO>> myFavorites(@RequestParam(defaultValue = "1") Integer page,
                                                @RequestParam(defaultValue = "10") Integer size) {
        return Result.success(articleQueryService.listMyFavorites(page, size));
    }
    ...
    public Result<Void> comment(@PathVariable Long id, @Valid @RequestBody CreateCommentDTO dto) {
        articleInteractionService.addComment(id, dto);
        return Result.success();
    }
    ...
    public Result<Void> deleteComment(@PathVariable Long id) {
        articleInteractionService.deleteComment(id);
        return Result.success();
    }
    ...
    public Result<IPage<CommentVO>> comments(@PathVariable Long id,
        ...
        return Result.success(articleQueryService.listComments(id, page, size));
    }
    ...
    public Result<List<ArticleVO>> hot(@RequestParam(defaultValue = "10") Integer limit) {
        return Result.success(articleQueryService.hotList(limit));
    }
}
